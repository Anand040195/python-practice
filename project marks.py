...
if total_marks>=90 and internal_marks>=50 and external_marks>=50 and external_marks>=50:
    print("A Grade")
if total_marks>=75 and total_marks<90 and internal_marks>=50 and external_marks>=50 and external_marks>=50:
    print("B Grade")
if total_marks>=50 and total_marks<75 and internal_marks>=50 and external_marks>=50 and external_marks>=50:
    print("C Grade")